...
function get_resdata(checkID, trackCheck, SvID) {
   var _c1 = checkID;
    ...
    $.ajax({
        url: "https://cors-anywhere-herokuapp.com/https://api.questionpro.com/a/api/v2/surveys/" + SvID + "/responses/filter?custom1="+ _c1 +"&apiKey=" + APIKey, //Filtra por correo electrónico
        type: "get",
